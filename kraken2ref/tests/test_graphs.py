from kraken2ref.src.graph_functions import build_graph, split_graph, find_all_paths
...
def __init__():
    ...
    test_split_output = [{(11, 'S'): [(12, 'S1')], (12, 'S1'): [(13, 'S2')], (13, 'S2'): [(14, 'S3'), (16, 'S3')], (14, 'S3'): [], (16, 'S3'): []},
