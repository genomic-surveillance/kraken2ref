...
def __init__():
    RUN_DIR = os.getcwd()
    test_tax_report = KrakenTaxonomyReport(sample_id="int_test", in_file="/Users/bd8/Developer/kraken2ref/kraken2ref/tests/fixtures/report.txt", outdir="./", min_abs_reads=3)
